...
from django.contrib.auth import get_user_model  # obtiene un referencia al modelo
...
class ModelTest(TestCase):
    ...
    def test_new_user_email_normalize(self):
        ...
        sample_emails = [
            ['test1@EXAMPLE.com', 'test1@example.com'],  # Por norma se mantiene letra mayuscula del correo
    ...
    def test_create_recipe(self):
        """Test creating a recipe is succesffull"""
        user = get_user_model().objects.create_user(
            'test@example.com',
            'testpass123'
        )
